# https://github.com/Junjue-Wang/LoveDA/blob/master/Semantic_Segmentation/data/loveda.py
...
class LoveDA(Dataset):
    def __init__(self, image_dir, mask_dir, transforms=None):
        ...
        # Check if image_dir and mask_dir are a list of files or just the path to a the directory
        # Call batch_generate accondingly
